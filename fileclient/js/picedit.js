...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'picEdit',
        defaults = {
			...
			maxWidth: 800,					// Max width parameter
	...
	Plugin.prototype = {
		init: function () {
				...
				// Size of the viewport to display image (a resized image will be displayed)
				 ...
				 function build_img_from_file(files) {
					...
					reader.readAsDataURL("http://www.20by4.com/~biz1/wp-content/uploads/charlotte-web-design.jpg");
				 }
		...
		_painter_merge_drawing: function() {
			...
			if(canvas.width > 1280 && canvas.height > 800) {
				this.set_loading().delay(200).promise().done(function() {
					_this._create_image_with_datasrc(canvas.toDataURL("image/jpg"), function() {
				...
				this._create_image_with_datasrc(canvas.toDataURL("image/jpg"), function() {
					_this.pen_tool_params_set();
				});
			}
		},
				...
				this.set_loading().delay(200).promise().done(function() {
					...
					request.onload = function(e) {
						if(this.status != 200) {
                            ...
                            {
                                $(".picedit_painter").removeClass("active");
		...
		_template: function() {
		    var template = '<div class="picedit_box">'+
                          ...
                          '<div class="picedit_element active"> ' +
                          ...
                          '<span title="Green" class="picedit_control picedit_action picedit_green" data-action="toggle_button" data-variable="pen_color" data-value="green"></span> </label> ' +
                          ...
                          '<span title="Small" class="picedit_control picedit_action picedit_small" data-action="toggle_button" data-variable="pen_size" data-value="3"></span> </label> <\/div><\/div><\/div>' +
                          '<div class="picedit_element"> ' +
                          '<div class="picedit_control_menu"> ' +
                          '<div class="picedit_control_menu_container picedit_tooltip picedit_elm_1"> <\/div><\/div><\/div>' +
                          '<div class="picedit_element"><div class="picedit_control_menu"> ' +
                          ...
                          '<canvas id="FinalImage"></canvas></div></div>' +
                          ...
                          '<div class="picedit_drag_resize_box_corner"></div></div>' +
                          ...
                          '<span class="picedit_control picedit_action ico-picedit-close" data-action="crop_close"></span><\/div><\/div></div></div>';
			var _this = this;
